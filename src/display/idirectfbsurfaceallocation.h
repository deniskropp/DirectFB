...
#ifndef __IDIRECTFBSURFACEALLOCATION_H__
#define __IDIRECTFBSURFACEALLOCATION_H__
...
/*
 * destroys surface allocation interface and frees private data
 */
void IDirectFBSurfaceAllocation_Destruct( IDirectFBSurfaceAllocation *thiz );

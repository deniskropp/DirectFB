...
extern "C"
{
     ...
     typedef enum {
          ...
          DIKT_SPECIAL        = 0x10000,     /* Special key (e.g. EPG) */
          DIKT_FUNCTION       = 0x20000,     /* Function key (F1 - Fn) */
          DIKT_MODIFIER       = 0x30000,     /* Modifier key */
          DIKT_LOCK           = 0x40000,     /* Lock key (e.g. CapsLock) */
          DIKT_DEAD           = 0x50000,     /* Dead key (e.g. dead grave) */
          DIKT_CUSTOM         = 0x60000,     /* Custom key (vendor specific) */
          DIKT_IDENTIFIER     = 0x70000      /* DirectFB key identifier */
     } DFBInputDeviceKeyType;

     #define DFB_KEY(type,index)        ((DIKT_##type) | (index))
     
     #define DFB_KEY_TYPE(symbol)       ((symbol) & 0xF0000)

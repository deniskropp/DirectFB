#ifndef __GP2D__GP2D_REGS_H__
#define __GP2D__GP2D_REGS_H__
...
#define GP2D_BEU_BASE  0xFE930000
...
/* BEU start register */
#define BESTR       (GP2D_BEU_BASE + 0x0000)

/* BEU source memory width register 1 */
#define BSMWR1      (GP2D_BEU_BASE + 0x0010)

/* BEU source size register 1 */
#define BSSZR1      (GP2D_BEU_BASE + 0x0014)

/* BEU source address Y register 1 */
#define BSAYR1      (GP2D_BEU_BASE + 0x0018)

/* BEU source address C register 1 */
#define BSACR1      (GP2D_BEU_BASE + 0x001C)

/* BEU source address A register 1 */
#define BSAAR1      (GP2D_BEU_BASE + 0x0020)

/* BEU source image format register 1 */
#define BSIFR1      (GP2D_BEU_BASE + 0x0024)

/* BEU source memory width register 2 */
#define BSMWR2      (GP2D_BEU_BASE + 0x0028)

/* BEU source size register 2 */
#define BSSZR2      (GP2D_BEU_BASE + 0x002C)

/* BEU source address Y register 2 */
#define BSAYR2      (GP2D_BEU_BASE + 0x0030)

/* BEU source address C register 2 */
#define BSACR2      (GP2D_BEU_BASE + 0x0034)

/* BEU source address A register 2 */
#define BSAAR2      (GP2D_BEU_BASE + 0x0038)

/* BEU source image format register 2 */
#define BSIFR2      (GP2D_BEU_BASE + 0x003C)

/* BEU source memory width register 3 */
#define BSMWR3      (GP2D_BEU_BASE + 0x0040)

/* BEU source size register 3 */
#define BSSZR3      (GP2D_BEU_BASE + 0x0044)

/* BEU source address Y register 3 */
#define BSAYR3      (GP2D_BEU_BASE + 0x0048)

/* BEU source address C register 3 */
#define BSACR3      (GP2D_BEU_BASE + 0x004C)

/* BEU source address A register 3 */
#define BSAAR3      (GP2D_BEU_BASE + 0x0050)

/* BEU source image format register 3 */
#define BSIFR3      (GP2D_BEU_BASE + 0x0054)

/* BEU tile pattern size register */
#define BTPSR       (GP2D_BEU_BASE + 0x0058)

/* BEU multidisplay source memory width register 1 */
#define BMSMWR1     (GP2D_BEU_BASE + 0x0070)

/* BEU multidisplay source size register 1 */
#define BMSSZR1     (GP2D_BEU_BASE + 0x0074)

/* BEU multidisplay source address Y register 1 */
#define BMSAYR1     (GP2D_BEU_BASE + 0x0078)

/* BEU multidisplay source address C register 1 */
#define BMSACR1     (GP2D_BEU_BASE + 0x007C)

/* BEU multidisplay source memory width register 2 */
#define BMSMWR2     (GP2D_BEU_BASE + 0x0080)

/* BEU multidisplay source size register 2 */
#define BMSSZR2     (GP2D_BEU_BASE + 0x0084)

/* BEU multidisplay source address Y register 2 */
#define BMSAYR2     (GP2D_BEU_BASE + 0x0088)

/* BEU multidisplay source address C register 2 */
#define BMSACR2     (GP2D_BEU_BASE + 0x008C)

/* BEU multidisplay source memory width register 3 */
#define BMSMWR3     (GP2D_BEU_BASE + 0x0090)

/* BEU multidisplay source size register 3 */
#define BMSSZR3     (GP2D_BEU_BASE + 0x0094)

/* BEU multidisplay source address Y register 3 */
#define BMSAYR3     (GP2D_BEU_BASE + 0x0098)

/* BEU multidisplay source address C register 3 */
#define BMSACR3     (GP2D_BEU_BASE + 0x009C)

/* BEU multidisplay source memory width register 4 */
#define BMSMWR4     (GP2D_BEU_BASE + 0x00A0)

/* BEU multidisplay source size register 4 */
#define BMSSZR4     (GP2D_BEU_BASE + 0x00A4)

/* BEU multidisplay source address Y register 4 */
#define BMSAYR4     (GP2D_BEU_BASE + 0x00A8)

/* BEU multidisplay source address C register 4 */
#define BMSACR4     (GP2D_BEU_BASE + 0x00AC)

/* BEU multidisplay source image format register */
#define BMSIFR      (GP2D_BEU_BASE + 0x00F0)

/* BEU blend control register 0 */
#define BBLCR0      (GP2D_BEU_BASE + 0x0100)

/* BEU blend control register 1 */
#define BBLCR1      (GP2D_BEU_BASE + 0x0104)

/* BEU process control register */
#define BPROCR      (GP2D_BEU_BASE + 0x0108)

/* BEU multiwindow control register 0 */
#define BMWCR0      (GP2D_BEU_BASE + 0x010C)

/* Blend location register 1 */
#define BLOCR1      (GP2D_BEU_BASE + 0x0114)

/* Blend location register 2 */
#define BLOCR2      (GP2D_BEU_BASE + 0x0118)

/* Blend location register 3 */
#define BLOCR3      (GP2D_BEU_BASE + 0x011C)

/* BEU multidisplay location register 1 */
#define BMLOCR1     (GP2D_BEU_BASE + 0x0120)

/* BEU multidisplay location register 2 */
#define BMLOCR2     (GP2D_BEU_BASE + 0x0124)

/* BEU multidisplay location register 3 */
#define BMLOCR3     (GP2D_BEU_BASE + 0x0128)

/* BEU multidisplay location register 4 */
#define BMLOCR4     (GP2D_BEU_BASE + 0x012C)

/* BEU multidisplay transparent color control register 1 */
#define BMPCCR1     (GP2D_BEU_BASE + 0x0130)

/* BEU multidisplay transparent color control register 2 */
#define BMPCCR2     (GP2D_BEU_BASE + 0x0134)

/* Blend pack form register */
#define BPKFR       (GP2D_BEU_BASE + 0x0140)

/* BEU transparent color control register 0 */
#define BPCCR0      (GP2D_BEU_BASE + 0x0144)

/* BEU transparent color control register 11 */
#define BPCCR11     (GP2D_BEU_BASE + 0x0148)

/* BEU transparent color control register 12 */
#define BPCCR12     (GP2D_BEU_BASE + 0x014C)

/* BEU transparent color control register 21 */
#define BPCCR21     (GP2D_BEU_BASE + 0x0150)

/* BEU transparent color control register 22 */
#define BPCCR22     (GP2D_BEU_BASE + 0x0154)

/* BEU transparent color control register 31 */
#define BPCCR31     (GP2D_BEU_BASE + 0x0158)

/* BEU transparent color control register 32 */
#define BPCCR32     (GP2D_BEU_BASE + 0x015C)

/* BEU destination memory width register */
#define BDMWR       (GP2D_BEU_BASE + 0x0160)

/* BEU destination address Y register */
#define BDAYR       (GP2D_BEU_BASE + 0x0164)

/* BEU destination address C register */
#define BDACR       (GP2D_BEU_BASE + 0x0168)

/* BEU address fixed register */
#define BAFXR       (GP2D_BEU_BASE + 0x0180)

/* BEU swapping register */
#define BSWPR       (GP2D_BEU_BASE + 0x0184)

/* BEU event interrupt enable register */
#define BEIER       (GP2D_BEU_BASE + 0x0188)

/* BEU event register */
#define BEVTR       (GP2D_BEU_BASE + 0x018C)

/* BEU register control register */
#define BRCNTR      (GP2D_BEU_BASE + 0x0194)

/* BEU status register */
#define BSTAR       (GP2D_BEU_BASE + 0x0198)

/* BEU module reset register */
#define BBRSTR      (GP2D_BEU_BASE + 0x019C)

/* BEU register-plane forcible setting register */
#define BRCHR       (GP2D_BEU_BASE + 0x01A0)


/* Color Lookup Table - CLUT registers (0-255) */
#define BCLUT(n)    (GP2D_BEU_BASE + 0x3000 + (n) * 0x04)



/* BEU source memory width registers (0-2) */
#define BSMWR(n)    (GP2D_BEU_BASE + 0x0010 + (n) * 0x18)

/* BEU source size registers (0-2) */
#define BSSZR(n)    (GP2D_BEU_BASE + 0x0014 + (n) * 0x18)

/* BEU source address Y registers (0-2) */
#define BSAYR(n)    (GP2D_BEU_BASE + 0x0018 + (n) * 0x18)

/* BEU source address C registers (0-2) */
#define BSACR(n)    (GP2D_BEU_BASE + 0x001C + (n) * 0x18)

/* BEU source address A registers (0-2) */
#define BSAAR(n)    (GP2D_BEU_BASE + 0x0020 + (n) * 0x18)

/* BEU source image format registers (0-2) */
#define BSIFR(n)    (GP2D_BEU_BASE + 0x0024 + (n) * 0x18)



/* BEU multidisplay source memory width registers (0-3) */
#define BMSMWR(n)   (GP2D_BEU_BASE + 0x0070 + (n) * 0x10)

/* BEU multidisplay source size registers (0-3) */
#define BMSSZR(n)   (GP2D_BEU_BASE + 0x0074 + (n) * 0x10)

/* BEU multidisplay source address Y registers (0-3) */
#define BMSAYR(n)   (GP2D_BEU_BASE + 0x0078 + (n) * 0x10)

/* BEU multidisplay source address C registers (0-3) */
#define BMSACR(n)   (GP2D_BEU_BASE + 0x007C + (n) * 0x10)



/* Blend location registers (0-2) */
#define BLOCR(n)    (GP2D_BEU_BASE + 0x0114 + (n) * 0x04)

/* BEU multidisplay location registers (0-3) */
#define BMLOCR(n)   (GP2D_BEU_BASE + 0x0120 + (n) * 0x04)

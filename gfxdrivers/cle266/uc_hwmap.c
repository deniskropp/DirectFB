                      ...
                      __u32* colormask, __u32* alphamask)
{
    ...
    {
    //case DSPF_RGB15:
    //  *colormask = 0x7fff7fff;
    //  *alphamask = 0x0;
    //  return HC_HDBFM_RGB555;
    case DSPF_ARGB1555:
        *colormask = 0x7fff7fff;
        *alphamask = 0x80008000;
    ...
    default:
        *colormask = 0x00ffffff;
        *alphamask = 0xff000000;
        return -1;  // Signals unsupported format
    }
}
...
int uc_map_src_format_3d(DFBSurfacePixelFormat format)
{
    ...
    case DSPF_RGB32:
        return HC_HTXnFM_ARGB0888;
    case DSPF_ARGB:
        return HC_HTXnFM_ARGB8888;
    case DSPF_A8:
        return HC_HTXnFM_A8;
    case DSPF_LUT8:
        return HC_HTXnFM_Index8;
    default:
        return -1;
    }
}

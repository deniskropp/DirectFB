...
#define UC_DRAWING_FLAGS_2D (DSDRAW_DST_COLORKEY | DSDRAW_XOR)
#define UC_BLITTING_FLAGS_2D (DSBLIT_SRC_COLORKEY | DSBLIT_DST_COLORKEY)

#define UC_DRAWING_FUNCTIONS_2D (DFXL_DRAWLINE | DFXL_DRAWRECTANGLE | \
                                DFXL_FILLRECTANGLE)
...
bool uc_blit_3d(void* drv, void* dev, DFBRectangle* rect, int dx, int dy);
bool uc_stretch_blit(void* drv, void* dev, DFBRectangle* sr, DFBRectangle* dr);
